...
async def index_document(
    ...
    This endpoint:
    1. Resolves all config from DB by knowledge_base_id reference
    2. Fetches content from the provided ContentRef
    3. Creates storage backend and embedding model from resolved configs
    4. Indexes the document chunks into the vector store
